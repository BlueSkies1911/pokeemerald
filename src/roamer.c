...
static const u8 sRoamerLocations[][6] =
{
    ...
    { MAP_NUM(ROUTE18), MAP_NUM(ROUTE17), MAP_NUM(ROUTE10), MAP_NUM(ROUTE11), MAP_NUM(ROUTE19), MAP_NUM(ROUTE123) },
    { MAP_NUM(ROUTE19), MAP_NUM(ROUTE18), MAP_NUM(ROUTE120), ___, ___, ___ },
    { MAP_NUM(ROUTE120), MAP_NUM(ROUTE19), MAP_NUM(ROUTE121), ___, ___, ___ },
    ...
    { MAP_NUM(ROUTE123), MAP_NUM(ROUTE122), MAP_NUM(ROUTE18), ___, ___, ___ },
