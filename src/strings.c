...
const u8 gText_ListByBodyColor[] = _("List by body colour.\nSpotted Pokémon only.");
...
const u8 gText_CantDismountBike[] = _("You can't dismount your Bicycle here.{PAUSE_UNTIL_PRESS}");
const u8 gText_DowsingMCHNNearby[] = _("Huh?\nThe Dowsing MCHN is responding!\pThere's an item buried around here!{PAUSE_UNTIL_PRESS}");
const u8 gText_DowsingMCHNOnTop[] = _("Oh!\nThe Dowsing MCHN is shaking wildly!{PAUSE_UNTIL_PRESS}");
const u8 gText_DowsingMCHNNothing[] = _("… … … …Nope!\nThere's no response.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Bicycle_1000000[] = _("Bicycle{CLEAR_TO 0x49}¥1,000,000");
const u8 gText_NoThanks[] = _("No Thanks");
const u8 gText_Eevee_1500Coins[] = _("Eevee{CLEAR_TO 0x48} 1,500 Coins");
const u8 gText_Pinsir_3000Coins[] = _("Pinsir{CLEAR_TO 0x48} 3,000 Coins");
const u8 gText_Scyther_3000Coins[] = _("Scyther{CLEAR_TO 0x48} 3,000 Coins");
const u8 gText_Dratini_5500Coins[] = _("Dratini{CLEAR_TO 0x48} 5,500 Coins");
const u8 gText_Porygon_9999Coins[] = _("Porygon{CLEAR_TO 0x48} 9,999 Coins");
...
const u8 gText_SmokeBall_800Coins[] = _("Smoke Ball{CLEAR_TO 0x51}800 Coins");
const u8 gText_MiracleSeed_1000Coins[] = _("Miracle Seed{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_Charcoal_1000Coins[] = _("Charcoal{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_MysticWater_1000Coins[] = _("Mystic Water{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_YellowFlute_1600Coins[] = _("Yellow Flute{CLEAR_TO 0x48}1,600 Coins");
...
const u8 gText_TM23AndPrice[] = _("TM23{CLEAR_TO 0x48}3,500 Coins");
const u8 gText_TM24AndPrice[] = _("TM24{CLEAR_TO 0x48}4,000 Coins");
const u8 gText_TM30AndPrice[] = _("TM30{CLEAR_TO 0x48}4,500 Coins");
...
const u8 gText_BulbasaurDoll80BP[] = _("Bulbasaur Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_CharmanderDoll80BP[] = _("Charmander Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_SquirtleDoll80BP[] = _("Squirtle Doll{CLEAR_TO 0x5E}80BP");
const u8 gText_KoffingDoll32BP[] = _("Koffing Doll{CLEAR_TO 0x5E}32BP");
const u8 gText_AbraDoll48BP[] = _("Abra Doll{CLEAR_TO 0x5E}48BP");
...
const u8 gText_MatchCallRival_Strategy[] = _("I'm the greatest strategist.");
const u8 gText_MatchCallRival_Pokemon[] = _("The strongest Pokémon!");
const u8 gText_MatchCallRival_Intro1[] = _("I'm the greatest Trainer.");
const u8 gText_MatchCallRival_Intro2[] = _("No one can defeat me!");
...
const u8 gJPText_NewTrainerHasComeToKanto[] = _("あらたな　トレーナーが\nホウエンに　やってきた！");
...
const u8 gText_SafariBallStock[] = _("{STR_VAR_1}/{STR_VAR_2}\nBalls  {STR_VAR_3}");
...
const u8 gText_DexKanto[] = _("Kanto");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these 3 Pokémon okay?");
...
const u8 gText_TrainerTower1F[] = _("1F");
const u8 gText_TrainerTower2F[] = _("2F");
const u8 gText_TrainerTower3F[] = _("3F");
const u8 gText_TrainerTower4F[] = _("4F");
...
const u8 gText_RivalMatchCallDesc[] = _("Rival");
const u8 gText_MomMatchCallDesc[] = _("Calm & Kind");
const u8 gText_MomMatchCallName[] = _("Mom");
const u8 gText_DaisyMatchCallDesc[] = _("{PKMN} Lover");
const u8 gText_DaisyMatchCallName[] = _("Daisy");
const u8 gText_ScottMatchCallDesc[] = _("Elusive Eyes");
const u8 gText_ScottMatchCallName[] = _("Scott");
const u8 gText_BrockMatchCallDesc[] = _("Rock Solid");
const u8 gText_MistyMatchCallDesc[] = _("Water Tomboy");
const u8 gText_LtSurgeMatchCallDesc[] = _("Electric Yank");
const u8 gText_ErikaMatchCallDesc[] = _("Grass Princess");
const u8 gText_KogaMatchCallDesc[] = _("Ninja Master");
const u8 gText_SabrinaMatchCallDesc[] = _("Teen Psychic");
const u8 gText_BlaineMatchCallDesc[] = _("Hot Head");
