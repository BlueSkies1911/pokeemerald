...
const u16 gMetatiles_TrickHouse[] = INCBIN_U16("data/tilesets/secondary/trick_house/metatiles.bin");
const u16 gMetatileAttributes_TrickHouse[] = INCBIN_U16("data/tilesets/secondary/trick_house/metatile_attributes.bin");
