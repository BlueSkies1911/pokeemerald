...
const u32 gTrainerPalette_Gambler[] = INCBIN_U32("graphics/trainers/palettes/gambler.gbapal.lz");
...
const u32 gTrainerPalette_OldMan[] = INCBIN_U32("graphics/trainers/palettes/old_man.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(RIVAL_LATE, RivalLate),
    ...
    TRAINER_SPRITE(CHAMPION_RIVAL, ChampionRival),
...
static const union AnimCmd sAnimCmd_OldMan[] =
{
    ANIMCMD_FRAME(1, 24),
    ANIMCMD_FRAME(2, 9),
    ANIMCMD_FRAME(3, 24),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(OLDMAN, 4, OldMan, Palette_OldMan, OldMan),
