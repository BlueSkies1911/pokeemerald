const u32 *const gDecorIconTable[][2] =
{
    ...
    [DECOR_EKANS_DOLL]      = {NULL, NULL},
    [DECOR_BULBASAUR_DOLL]  = {NULL, NULL},
    [DECOR_CHARMANDER_DOLL] = {NULL, NULL},
    [DECOR_SQUIRTLE_DOLL]   = {NULL, NULL},
    [DECOR_PIKACHU_DOLL]    = {NULL, NULL},
    [DECOR_SHELLDER_DOLL]   = {NULL, NULL},
    [DECOR_ABRA_DOLL]       = {NULL, NULL},
    [DECOR_JIGGLYPUFF_DOLL] = {NULL, NULL},
    [DECOR_MEOWTH_DOLL]     = {NULL, NULL},
    [DECOR_CLEFAIRY_DOLL]   = {NULL, NULL},
    [DECOR_DITTO_DOLL]      = {NULL, NULL},
    [DECOR_KOFFING_DOLL]    = {NULL, NULL},
    [DECOR_ELECTABUZZ_DOLL] = {NULL, NULL},
    [DECOR_MAGMAR_DOLL]     = {NULL, NULL},
    [DECOR_JYNX_DOLL]       = {NULL, NULL},
    [DECOR_GASTLY_DOLL]     = {NULL, NULL},
    [DECOR_EEVEE_DOLL]      = {NULL, NULL},
    [DECOR_SANDSHREW_DOLL]  = {NULL, NULL},
    [DECOR_VOLTORB_DOLL]    = {NULL, NULL},
    [DECOR_POLIWAG_DOLL]    = {NULL, NULL},
    [DECOR_GROWLITHE_DOLL]  = {NULL, NULL},
    [DECOR_DRATINI_DOLL]    = {NULL, NULL},
    [DECOR_GRIMER_DOLL]     = {NULL, NULL},
    [DECOR_ODDISH_DOLL]     = {NULL, NULL},
    [DECOR_BELLSPROUT_DOLL] = {NULL, NULL},
    ...
    [DECOR_KINGLER_DOLL]    = {gDecorIcon_KinglerDoll, gDecorIconPalette_KinglerDoll},
    [DECOR_ARTICUNO_DOLL]   = {gDecorIcon_ArticunoDoll, gDecorIconPalette_ArticunoDoll},
    [DECOR_ZAPDOS_DOLL]     = {gDecorIcon_ZapdosDoll, gDecorIconPalette_ZapdosDoll},
    [DECOR_MOLTRES_DOLL]    = {gDecorIcon_MoltresDoll, gDecorIconPalette_MoltresDoll}
};
