...
{
    [CONTEST_CATEGORY_COOL]   = OBJ_EVENT_GFX_BILL,
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_SEEL,
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_CLEFAIRY,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_LAPRAS,
...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_RATTATA,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_MEOWTH,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_CLEFAIRY,
    [CONTEST_CATEGORY_SMART]  = SPECIES_ABRA,
