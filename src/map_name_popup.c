...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_THREE_ISLE_PATH] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_UNDERGROUND_PATH_2] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_ROCKET_WAREHOUSE] = MAPPOPUP_THEME_MARBLE,
...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    if (regionMapSectionId >= HOENN_MAPSEC_START)
    {
