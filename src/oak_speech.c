...
static void Task_PikachuIntro_LoadPage1(u8 taskId)
{
    ...
    else
    {
        ...
        tTextCursorSpriteId = CreateTextCursorSpriteForOakSpeech(0, 226, 145, 0, 0);
...
static void Task_OakSpeech_ReturnNidoranFToPokeBall(u8 taskId)
{
    ...
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        spriteId2 = NewGameOakSpeech_CreateNidoranFSprite(0x60, 0x60);
        gTasks[taskId].tPokeBallSpriteId = CreateTradePokeballSprite(spriteId2, gSprites[spriteId2].oam.paletteNum, 100, 66, 0, 0, 32, 0xFFFF1F3F);
