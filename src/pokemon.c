...
{
    MOVE_CUT, MOVE_TELEPORT, MOVE_SURF, MOVE_STRENGTH, MOVE_FLASH,
...
STATIC_ASSERT(MOVES_COUNT < (1 << 11), PokemonSubstruct1_moves_TooSmall);
...
bool8 CheckBattleTypeGhost(struct Pokemon *mon, u8 battler)
{
