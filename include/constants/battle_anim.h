...
#define ANIM_TAG_WOOD_HAMMER                (ANIM_SPRITES_START + 303)
#define ANIM_TAG_PSYCHO_CUT                 (ANIM_SPRITES_START + 304)
#define ANIM_TAG_POWER_GEM                  (ANIM_SPRITES_START + 305)
#define ANIM_TAG_STONE_EDGE                 (ANIM_SPRITES_START + 306)
#define ANIM_TAG_STEALTH_ROCK               (ANIM_SPRITES_START + 307)
#define ANIM_TAG_POISON_JAB                 (ANIM_SPRITES_START + 308)
#define ANIM_TAG_GREEN_POISON_BUBBLE        (ANIM_SPRITES_START + 309)
#define ANIM_TAG_FLASH_CANNON_BALL          (ANIM_SPRITES_START + 310)
#define ANIM_TAG_WATER_GUN                  (ANIM_SPRITES_START + 311)
#define ANIM_TAG_PUNISHMENT_BLADES          (ANIM_SPRITES_START + 312)
#define ANIM_TAG_QUICK_GUARD_HAND           (ANIM_SPRITES_START + 313)

#define ANIM_TAG_SHELL_RIGHT                (ANIM_SPRITES_START + 314)
#define ANIM_TAG_SHELL_LEFT                 (ANIM_SPRITES_START + 315)
#define ANIM_TAG_RAZOR_SHELL                (ANIM_SPRITES_START + 316)
#define ANIM_TAG_ASSURANCE_HAND             (ANIM_SPRITES_START + 317)
#define ANIM_TAG_BERRY_NORMAL               (ANIM_SPRITES_START + 318)
