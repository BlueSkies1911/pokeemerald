...
bool8 MetatileBehavior_IsSemiDeepWater(u8);
...
bool8 MetatileBehavior_IsCyclingRoadPullDownTileGrass(u8);
...
bool8 MetatileBehavior_IsFallWarp(u8);
...
bool8 MetatileBehavior_IsWarpPad(u8);
bool8 MetatileBehavior_IsUnionRoomWarp(u8);
...
bool8 MetatileBehavior_IsPokeMartShelf(u8);
...
bool8 MetatileBehavior_IsIndigoPlateauMark(u8);
bool8 MetatileBehavior_IsIndigoPlateauMark2(u8);
bool8 MetatileBehavior_IsFood(u8);
bool8 MetatileBehavior_IsRockStairs(u8);
bool8 MetatileBehavior_IsBlueprints(u8);
...
bool8 MetatileBehavior_IsTrashBin(u8);
bool8 MetatileBehavior_IsCup(u8);
bool8 MetatileBehavior_IsPolishedWindow(u8);
bool8 MetatileBehavior_IsBeautifulSkyWindow(u8);
...
bool8 MetatileBehavior_IsBurglary(u8);
...
bool8 MetatileBehavior_IsTrainerTowerTimer(u8);
