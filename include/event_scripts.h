...
extern const u8 EventScript_TrainerTowerTimer[];
...
extern const u8 SaffronCity_Dojo_EventScript_KoichiCall[];
...
// trainer tower
extern const u8 TrainerTower_EventScript_TrainerBattle[];
